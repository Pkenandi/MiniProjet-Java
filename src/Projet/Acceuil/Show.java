...
public class Show 
{
	...
	public static void Boot() throws IOException 
	{
		...
		do
		{
			...
			System.out.println("\t Societé de Location Immobilière    ");
			System.out.println("\n");
			...
			case 1: {
				...
				do {
					...
					System.out.println("\n\n");
					System.out.println("\t Vous etes connectez en tant que < Administrateur > ");
					System.out.println("\n\t [ 1 ] Gerer les Comptes ");
					System.out.println("\n\t [ 2 ] Gerer les Maisons ");
					System.out.print("\n\t ==> : ...  ");
					...
					case 1:{
						...
						do {
							...
							if (compte.equals(1)) {
								...
								Ooc.Creation();
								System.out.println("\n\t Creation effectuer avec succès :/ ");
					...
					case 2:
					{
						...
						do
						{
							...
							if (maison.equals(1)) {
								System.out.println("\n\t  < Ajout d'une maison >  \n");
								Oom.addHouse();
								System.out.println("\n\t Ajout effecter avec succès :/ ");
							} else if (maison.equals(2)) {
							...
							} else if (maison.equals(3)) {
								System.out.println("\n\t < Suppression d'une Maison > \n");
								Scanner sc2 = new Scanner(System.in);
								System.out.print("\n\t Id de la maison :  ");
								Integer id = sc2.nextInt();
								Oom.distroyHouse(id);
							} else if (maison.equals(4)) {
								System.out.println("\n\t < Recherche d'une Maison > \n");
								Scanner sc3 = new Scanner(System.in);
								System.out.print("\n\t Id de la maison :  ");
								Integer id = sc3.nextInt();
								Oom.searchHouse(id);
							} else if (maison.equals(5)) {
			...
			case 2: {
				...
				do {
					...
					for(i = 0; i < Ooc.compte.size(); i++)
					{
						...
						{
							System.out.println("\n\n");
							System.out.println("\t  Welcom [" + userName +"] as < Gerant >");
							System.out.println("\n\t [ 1 ] Gerer les clients ");
							...
							case 2: {
								...
								do {
									...
									if (contract.equals(1)) {
										...
										{
											System.out.println(" Code client invalide !");
											break;
										}
							...
							case 3: {
								...
								do {
									...
									if (facture.equals(1)) {
										...
										Oof.addFacture();
										System.out.println("\n\t Ajout effectuer avec succès :/ ");
									} else if (facture.equals(2)) {
										System.out.println("\n\t < Modification d'une Facture > \n ");
										Scanner sc1 = new Scanner(System.in);
										System.out.print("\n\t Numero de la facture à modifier :  ");
										Integer num = sc1.nextInt();
										Oof.updateFacture(num);
									} else if (facture.equals(3)) {
										System.out.println("\n\t < Suppression d'une Facture > \n");
										Scanner sc2 = new Scanner(System.in);
										System.out.print("\n\t Numero de la facture à supprimer :  ");
										Integer code = sc2.nextInt();
										Oof.distroyFacture(code);
									} else if (facture.equals(4)) {
